...
8. Phase 7: PORT-01 then DETAIL-01. PORT-01 is frozen by Sprint 06. DETAIL-01 remains proposal-only until separately approved. Preserve repository/image/cloud behavior; migration and destructive-action tests.
