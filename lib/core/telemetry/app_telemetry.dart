...
enum TelemetryProviderType {
  ...
  firebase(displayName: 'Firebase placeholder'),
...
class TelemetryConfig {
  ...
  factory TelemetryConfig.fromEnvironment() {
    return TelemetryConfig(
      ...
      firebaseConfigured: const String.fromEnvironment(
        'COLLECTIQ_FIREBASE_APP_ID',
      ).trim().isNotEmpty,
...
class NoopTelemetryService implements AppTelemetryService {
  ...
  TelemetryStatus get status => TelemetryStatus(
    ...
    message: 'Telemetry disabled. Local/offline mode is unaffected.',
  );
